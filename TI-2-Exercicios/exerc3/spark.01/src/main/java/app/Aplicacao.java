...
public class Aplicacao {
	...
	public static void main(String[] args) {
		...
		get("/concurso/:id", (request, response) -> concursosService.delete(request, response));
		get("/concurso/:id", (request, response) -> concursosService.get(request, response));
		post("/produto/update/:id", (request, response) -> concursosService.update(request, response));
	}
}
